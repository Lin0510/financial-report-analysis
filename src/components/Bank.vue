    ...
    <tbody class="b_body">
      ...
      <tr>
        ...
        <td id="copy">
          <button
            class="btn"
            :class="{ 'btn-outline-dark': !isTotalCopied, 'btn-success': isTotalCopied }"
            type="button"
...
function calculate() {
  ...
  const value = ((netInterestIncome.value / totalRevenue.value) * 100).toFixed(2);
  ratio.value = `${value} %`;
